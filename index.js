...
const app = express()
const url = 'mongodb+srv://superadmin:galaxy1141@cluster0.od5zc.mongodb.net/sample_weatherdata?retryWrites=true&w=majority'
...
app.get('/weather', async (req, res) => {
    try {
        ...
        const cursor = collection.find(query).limit(4)
        let weather = []
